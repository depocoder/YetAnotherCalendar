    ...
    return (
        <div className="privacy-page__card privacy-page__card--live">
            ...
            <p className="privacy-page__data-note">
                ...
                календаря удаляет сохраненный вход, а про подписку спросит отдельно.
            </p>
        </div>
    );
};
        ...
        <main className="privacy-page__main">
            ...
            <div className="privacy-page__card">
                ...
                <div className="privacy-page__note">
                    ...
                    встроен в вашу персональную ссылку и нигде больше не существует. Мы
                    устранили все пути, которыми секрет из ссылки мог бы стать читаемым:
                    он вычищается из логов приложения и веб-сервера, из отчетов об ошибках
                    и не попадает в сообщения об ошибках API. Никто — включая
                    разработчиков — не может увидеть вашу ссылку. И даже сама ссылка не
                    дает доступа к логину и паролю: по ней можно только получить календарь
                    или удалить подписку, других операций не существует.
                </div>
            </div>
